...
#pragma config(Sensor, in4,    ClawRight_Pot,  sensorPotentiometer)
#pragma config(Sensor, in5,    ClawLeft_Pot,   sensorPotentiometer)
...
#define ClawLeft_Open 1840 //(150)
#define ClawLeft_Closed 3445 //(2310)
#define ClawLeft_ClosedCube 3000
#define ClawLeft_Mid 2650

#define ClawRight_Open 2028 //(150)
#define ClawRight_Closed 3970 //(2310)
#define ClawRight_ClosedCube 3000
#define ClawRight_Mid 2865
...
void LeftCube(){
	...
	wait1Msec(300);
	//RotateAngle(90,1000,100);
	SetDriveControl(Line, -29, 2);
	wait1Msec(300);
	RotateAngle(-80,1000,100);
	//RotateAngle(-10,1000,100);
	SetDriveControl(Line, -14.5, 1.5);
	wait1Msec(150);
	SetLiftPosition(Lift_Pos3+200);
	wait1Msec(1050);
	ClawPos = Open;
