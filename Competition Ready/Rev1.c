...
#pragma config(Motor,  port1,           leftDriveBack, tmotorVex393HighSpeed, openLoop)
#pragma config(Motor,  port2,           rightInside,   tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port3,           rightOutside,  tmotorVex393, openLoop)
#pragma config(Motor,  port4,           rightDriveFront, tmotorVex393HighSpeed, openLoop, reversed)
#pragma config(Motor,  port5,           clawRight,     tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port6,           clawLeft,      tmotorVex393, openLoop)
#pragma config(Motor,  port7,           leftDriveFront, tmotorVex393HighSpeed, openLoop)
#pragma config(Motor,  port8,           leftOutside,   tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port9,           leftInside,    tmotorVex393, openLoop)
#pragma config(Motor,  port10,          rightDriveBack, tmotorVex393HighSpeed, openLoop, reversed)
...
#define Claw_Open 3480 //(150)
#define Claw_Closed 1200 //(2310)
#define Claw_ClosedCube 1565
#define Claw_Mid 2250
#define Mid 0
#define Closed 1
#define Open 2
...
task ProgramChooser() {
	...
	while (!picked) {
		...
		switch (auto) {
		case 0: autoName = "[BlueRight]"; break;
		case 1: autoName = "[FullcourtCapRd]"; break;
		case 2: autoName = "[Block Mid]"; break;
		case 3: autoName = "[Hoard In][Blue]" ; break;
		case 4: autoName = "[Hoard Out][Blue]"; break;
		case 5: autoName = "[Hoard In][Red]"; break;
		case 6: autoName = "[Hoard Out][Red]"; break;
		case 7: autoName = "[PROG][SKILLS]"; break;
		case 8: autoName = "[FullcourtCapBl]"; break;
...
SetLiftPosition(Lift_Pos1);
    ...
    wait1Msec(300);
    RotateAngle(90,1000,100);
    SetDriveControl(Line, -12, 2);
    wait1Msec(500);
    RotateAngle(-10,1000,100);
    SetDriveControl(Line, -10, 2);
    wait1Msec(500);
...
task autonomous(){
	...
	switch(auto) {
	case 0: blueRight(); break;
	case 1: FCCapRedOut(); break;
	case 2: BlockMid(); break;
	case 3: HoardInBlue(); break;
	case 4: HoardOutBlue(); break;
	case 5: HoardInRed(); break;
	case 6: HoardOutRed(); break;
	case 7: ProgSkills(); break;
	case 8: FCCapBlueOut(); break;
	}
