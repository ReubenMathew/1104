...
#pragma config(Sensor, in7,    RightClawPot,   sensorPotentiometer)
...
#pragma config(Sensor, dgtl11, Drive_Encoder,  sensorQuadEncoder)
#pragma config(Motor,  port1,           LeftClaw,      tmotorVex393_HBridge, openLoop, reversed)
#pragma config(Motor,  port2,           RightClaw,     tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port3,           Lift_A,        tmotorVex393TurboSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port4,           RightDriveA,   tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port5,           LeftDriveB,    tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port6,           RightDriveB,   tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port7,           LeftDriveA,    tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port8,           Lift_C,        tmotorVex393TurboSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           Lift_B,        tmotorVex393_MC29, openLoop)
...
#define RightClaw_Open 1600 //(150)
#define RightClaw_Closed 624 //(2310)
#define RightClaw_Mid 1185

volatile int RightClaw_Position = 0;
volatile int RightClaw_Power;

#define LeftClaw_Open 2200 //(150)
#define LeftClaw_Closed 3331 //(2310)
#define LeftClaw_Mid 2550
