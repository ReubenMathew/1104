...
#pragma config(Motor,  port4,           RightClaw,     tmotorVex393TurboSpeed_MC29, openLoop)
...
#pragma config(Motor,  port7,           LeftClaw,      tmotorVex393TurboSpeed_MC29, openLoop)
...
task usercontrol(){
	...
	motor[RightDrive] = vexRT[Ch1] > 100 || vexRT[Ch1] < -100 ? (TankDrivePower*arcadeTurnConst) -vexRT[Ch1] : TankDrivePower-vexRT[Ch1];
	motor[LeftDrive] = vexRT[Ch1] > 100 || vexRT[Ch1] < -100 ? (TankDrivePower*arcadeTurnConst) +vexRT[Ch1] : TankDrivePower+vexRT[Ch1];
