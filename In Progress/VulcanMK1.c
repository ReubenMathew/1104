...
#pragma config(Motor,  port1,           rightDriveBack, tmotorVex393HighSpeed_HBridge, openLoop, reversed)
...
#pragma config(Motor,  port10,          leftDriveBack, tmotorVex393HighSpeed_HBridge, openLoop)
