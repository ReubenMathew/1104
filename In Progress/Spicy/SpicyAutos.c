...
void Paarth(){
	...
	float turnFactor = 1.25;

	//FIRST LOAD
	Lift_PositionCount = 1;
	SetDriveControl(Line, 15*B, 3);
	ClawPos = Open;
	wait1Msec(1500);
	ClawPos = Closed;
	wait1Msec(500);
	Lift_PositionCount = 2;
	wait1Msec(250);
	SetDriveControl(Line, 35*B, 2.5);
	wait1Msec(250);
	PaarthsDump();
	wait1Msec(500);
	//SECOND LOAD
	SetDriveControl(Line, 31, 3);
	wait1Msec(1000);
	ClawPos = Closed;
	wait1Msec(500);
	Lift_PositionCount = 2;
	wait1Msec(100);
	SetDriveControl(Line, 37*B, 2.5);
	wait1Msec(250);
	PaarthsDump();
	wait1Msec(500);
	//THIRD LOAD
	SetDriveControl(Line, 30, 3);
	wait1Msec(1000);
	ClawPos = Closed;
	wait1Msec(500);
	Lift_PositionCount = 2;
	...
	wait1Msec(500);
	//CUBE
	SetDriveControl(Line, 23, 2);
	wait1Msec(300);
	SetDriveControl(Rotation, 90 * turnFactor, 2);
	wait1Msec(300);
	SetDriveControl(Line, 22.5, 2);
	wait1Msec(250);
	ClawPos = Closed;
	wait1Msec(250);
	Lift_PositionCount = 2;
	...
	wait1Msec(250);
	SetDriveControl(Rotation, 90 * turnFactor * -1, 1);
	wait1Msec(250);
	...
	Lift_PositionCount = 2;
	wait1Msec(250);
	SetDriveControl(Rotation, 90 * turnFactor * -1, 2);
	wait1Msec(300);
	PaarthsDump();
	//LAST CUBE
	wait1Msec(300);
	SetDriveControl(Line, 7, 2);
	wait1Msec(200);
	SetDriveControl(Rotation, 90 * turnFactor, 2);
	wait1Msec(300);
	SetDriveControl(Line, 32, 3);
	wait1Msec(300);
	SetDriveControl(Rotation, 90 * turnFactor * -1, 2);
	wait1Msec(300);
	SetDriveControl(Line, 30, 3);
...
void Aditya1(){ // Grabs cube, dumps in middle fence, grabs middle 3 stars and dumps in middle fence
float turnErrorFactor = 1.35;
Lift_PositionCount = 1;
wait1Msec(250);
SetDriveControl(Line, 21, 1);
wait1Msec(250);
...
Lift_PositionCount = 2;
wait1Msec(250);
SetDriveControl(Line, 9, 1);
wait1Msec(250);
SetDriveControl(Rotation, 90 * turnErrorFactor, 1);
wait1Msec(250);
SetDriveControl(Line, -24, 1);
wait1Msec(250);
Lift_PositionCount = 3;
wait1Msec(750);
ClawPos = Open;
...
void CubePTR(int side){

float turnErrorFactor = 1.25;
...
SetDriveControl(Line, 21, 1);
wait1Msec(250);
SetDriveControl(Rotation, 90 * turnErrorFactor * side, 1);
wait1Msec(250);
SetDriveControl(Line, 19, 1);
wait1Msec(250);
ClawPos = Closed;
wait1Msec(250);
Lift_PositionCount = 2;
