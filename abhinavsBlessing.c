...
#pragma config(Motor,	 port2,						Lift_B,				 tmotorVex393_MC29, openLoop)

#pragma config(Motor,	 port3,						Lift_A,				 tmotorVex393TurboSpeed_MC29, openLoop)

#pragma config(Motor,	 port4,						Lift_C,				 tmotorVex393HighSpeed_MC29, openLoop)

#pragma config(Motor,	 port5,						ClawRight,		 tmotorVex393HighSpeed_MC29, openLoop)

#pragma config(Motor,	 port6,						ClawLeft,			 tmotorVex393HighSpeed_MC29, openLoop)
